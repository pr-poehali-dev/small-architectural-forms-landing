...
def handler(event: dict, context) -> dict:
    """Отправляет заявку с формы обратной связи (раздел Контакты) на почту владельца студии."""
    ...
    message_block = f"""
                <tr>
                  <td style="padding:14px 20px;">
                    <p style="margin:0;font-size:12px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:1px;">О проекте</p>
                  </td>
                  <td style="padding:14px 20px;">
                    <p style="margin:0;font-size:14px;color:rgba(255,255,255,0.75);line-height:1.6;">{message}</p>
                  </td>
                </tr>
    """ if message else ""
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#1c1915;border-radius:16px;overflow:hidden;border:1px solid rgba(255,107,26,0.2);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#FF6B1A,#E8231A);padding:32px 40px;text-align:center;">
              <p style="margin:0;font-size:11px;letter-spacing:4px;text-transform:uppercase;color:rgba(255,255,255,0.7);font-weight:500;">НОВАЯ ЗАЯВКА С САЙТА</p>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:rgba(255,255,255,0.5);line-height:1.5;">
                Клиент оставил заявку через форму обратной связи на сайте. Свяжитесь с ним в ближайшее время.
              </p>

              <!-- Contact info -->
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,0.06);">
                <tr>
                ...
                <tr>
                  <td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);width:38%;">
                ...
                <tr>
                  ...
                  <td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);">
                    <p style="margin:0;font-size:16px;color:#FF6B1A;font-weight:700;">{phone}</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:14px 20px;{'' if message else ''}">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:linear-gradient(135deg,rgba(255,107,26,0.10),rgba(232,35,26,0.05));padding:20px 24px;border:1px solid rgba(255,107,26,0.15);border-radius:12px;">
                    <p style="margin:0;font-size:13px;color:rgba(255,255,255,0.6);line-height:1.6;">
                      ⚡ Рекомендуется связаться с клиентом в течение <strong style="color:#FF6B1A;">1–2 часов</strong> — это значительно увеличивает шанс закрытия сделки.
                    </p>
                  </td>
                </tr>
              </table>
